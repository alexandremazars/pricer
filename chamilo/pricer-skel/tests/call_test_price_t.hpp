...
#ifndef MC_PRICER_CALL_TEST_PRICE_T_H
#define MC_PRICER_CALL_TEST_PRICE_T_H
...
double r = 0.02;
double rho = 0;
PnlVect *sigma = pnl_vect_create_from_scalar(1,0.200000);
PnlVect *spot = pnl_vect_create_from_scalar(1,100.000000);
...
#endif //MC_PRICER_CALL_TEST_PRICE_T_H
